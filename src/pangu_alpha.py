...
class Dropout(nn.Cell):
    r"""
        A Dropout Implements with ops.Dropout and  ops.Dropout for parallel training.
    """
    ...
    def __init__(self, keep_prob=0.5, dtype=mstype.float32):
        ...
        if self.is_ascend:
            ...
            self.dropout_gen_mask = ops.Dropout(Seed0=self.seed0, Seed1=self.seed1)
            self.dropout_do_mask = ops.Dropout()
            self.cast = P.Cast()
        else:
